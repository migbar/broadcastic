...
describe Broadcastic::PusherService do

	context "Running on a non-evented server" do
		it "broadcasts through Pusher when a record is created" do
		...
		it "broadcasts through Pusher when a record is updated" do
		...
		it "broadcasts through Pusher when a record is destroyed" do
